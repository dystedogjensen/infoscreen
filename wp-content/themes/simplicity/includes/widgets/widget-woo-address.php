...
class WP_Widget_Address extends WP_Widget {
	...
	function WP_Widget_Address() {
		$widget_ops = array('classname' => 'widget_address', 'description' => __( 'Text or HTML with Google Maps functionality', 'woothemes' ) );
		$control_ops = array('width' => 400, 'height' => 350);
		$this->WP_Widget('woo_address', __( 'Woo - Address', 'woothemes' ), $widget_ops, $control_ops);
	}
...
?>
		...
		<p><label for="<?php echo $this->get_field_id('subtitle'); ?>"><?php _e( 'Sub Title:', 'woothemes' ); ?></label>
		...
		<p><input id="<?php echo $this->get_field_id('filter'); ?>" name="<?php echo $this->get_field_name('filter'); ?>" type="checkbox" <?php checked(isset($instance['filter']) ? $instance['filter'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id('filter'); ?>"><?php _e( 'Automatically add paragraphs', 'woothemes' ); ?></label></p>

		<p><label for="<?php echo $this->get_field_id('coords'); ?>"><?php _e( 'Location Coordinates:', 'woothemes' ); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('zoom'); ?>"><?php _e( 'Zoom Level:', 'woothemes' ); ?></label>
