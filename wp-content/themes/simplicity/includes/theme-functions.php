...
if ( ! function_exists( 'woo_add_slide_pages' ) ) {
/**
 * Register the "slide-page" taxonomy, assigning it to the "slide" post type.
 * @since  1.10.0
 * @return void
 */
function woo_add_slide_pages () {
...
} // End woo_add_slide_pages()
}

add_action( 'init', 'woo_add_slide_pages' );
