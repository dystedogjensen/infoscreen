...
if (!function_exists('woo_custom_styling')) {
	function woo_custom_styling() {
		...
		if ($link)
			$output .= '#wrapper a {color:'.$link.'}' . "\n";

		if ($hover)
			$output .= '#wrapper a:hover, .post-more a:hover, .post-meta a:hover, .post p.tags a:hover {color:'.$hover.'}' . "\n";

		if ($button) {
			$output .= '#wrapper a.button, #wrapper a.comment-reply-link, #commentform #submit, #contact-page .submit, #connect .newsletter-form .submit {background:'.$button.';border-color:'.$button.'}' . "\n";
			$output .= '#wrapper a.button:hover, #wrapper a.button.hover, #wrapper a.button.active, #wrapper a.comment-reply-link:hover, #wrapper #commentform #submit:hover, #wrapper #contact-page .submit:hover, #connect .newsletter-form .submit {background:'.$button.';opacity:0.9;}' . "\n";
		}
