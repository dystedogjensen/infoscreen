...
//-->!]]>
    ...
    <div id="content" class="col-full page">
	                        ...
	                        <?php if( isset( $hasError ) || isset( $captchaError ) ) { ?>
                   		 	...
                   		 	<form action="<?php echo esc_url( get_permalink( get_the_ID() ) ); ?>" id="contactForm" method="post">
                   		 	    ...
                   		 	    <ol class="forms">
                   		 	        ...
                   		 	        <li><input type="checkbox" name="sendCopy" id="sendCopy" value="true"<?php if( isset( $_POST['sendCopy'] ) && $_POST['sendCopy'] == true ) { echo ' checked="checked"'; } ?> /><label for="sendCopy"><?php _e( 'Send a copy of this email to yourself', 'woothemes' ); ?></label></li>
                   		 	        ...
                   		 	        <li><input type="hidden" name="submitted" id="submitted" value="true" /><input class="submit button" type="submit" value="<?php esc_attr_e( 'Send Message', 'woothemes' ); ?>" /></li>
                   		 	    </ol>
                   		 	</form>
