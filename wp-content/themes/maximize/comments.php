...
<div id="comments">
	...
	<?php if ( ! empty( $comments_by_type['comment'] ) ) { ?>
		<h1><?php comments_number( __( 'No Responses', 'woothemes' ), __( 'One Response', 'woothemes' ), __( '% Responses', 'woothemes' ) ); ?> <?php _e( 'to', 'woothemes' ); ?> &#8220;<?php the_title(); ?>&#8221;</h1>

		<ol class="commentlist">

			<?php wp_list_comments( 'avatar_size=140&callback=custom_comment&type=comment' ); ?>
