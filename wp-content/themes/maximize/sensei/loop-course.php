 ...
 * MODIFICATIONS
 * =============
 * 1. Added masonry-wrap-courses div.
 * 2. Remove .fix divs
 */
...
if ( ! $paged || $paged < 2 ) {
    ...
    if ( count( $posts_array ) > 0 ) { ?>
    	...
    	<section id="main-course" class="course-container">
            ...
            <div class="masonry-wrap-courses">
    			...
    			<article class="<?php echo esc_attr( join( ' ', get_post_class( array( 'course', 'post' ), $post_id ) ) ); ?>">
    				...
    				<section class="entry">
    					<p class="sensei-course-meta">
    					   ...
    					   <span class="course-lesson-count"><?php echo $woothemes_sensei->post_types->course->course_author_lesson_count( $author_id, $post_id ) . '&nbsp;' . apply_filters( 'sensei_lessons_text', __( 'Lessons', 'woothemes-sensei' ) ); ?></span>
